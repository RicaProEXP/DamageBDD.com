            ...
            <div className="col-md-12">
              ...
              <div className="footer__bottom">
                <a href="index.html" className="logo">
                  <img src="assets/images/logo/logo.png" height={100} width={190} alt="" />
                </a>
                <div className="center mb--30">
                  <ul className="list">
                    ...
                    <li>
                      <a href="nft.html">Get started!</a>
                    </li>
                    <li>
                      <a href="about.html">Pricing</a>
                    </li>
                    <li>
                      <a href="nft.html">Articles</a>
                    </li>
                    <li>
                  ...
                  <p>Copyright © 2024, DamageBDD. Designed by <a href="https://odidor.co" target='_blank'>ODIDOR</a></p>
                </div>
