            ...
            <div className="col-12">
              <div className="block-text center">
                <h6 className="sub-heading">
                  <span>Join BDD Portfolio</span>
                </h6>
                <h3 className="headingwow" data-splitting="">
                  Join DamageBDD: Unlock the Power of Collaborative BDD <br />
                  Revolutionizing Cross-Functional Development
                </h3>
              </div>
            </div>
              ...
              <div className="portfolio__left">
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    <h5 className="title">Connect Your Wallet to DamageBDD</h5>
                    <p>
                      Unlock the full potential of DamageBDD by connecting your
                      wallet. Engage in collaborative Behavior Driven
                      Development (BDD), participate in test writing, and
                      leverage the power of decentralized finance (DeFi) for
                      secure and efficient project execution. Start contributing
                      today!
                    </p>
                  </div>
                </div>
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    <h5 className="title">Buy Your DamageBDD NFT</h5>
                    <p>
                      Purchase exclusive DamageBDD NFTs and become part of the
                      innovative Behavior Driven Development community. These
                      NFTs grant access to unique features, rewards, and
                      governance within the DamageBDD ecosystem. Start your
                      journey today and contribute to the future of
                ...
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    <h5 className="title">Create Your DamageBDD Collection</h5>
                    <p>
                      Build and manage your own collection of test scenarios,
                      smart contracts, and other digital assets within the
                      DamageBDD ecosystem. Harness the power of decentralized
                      collaboration and streamline your testing processes with
                      custom collections tailored to your project's needs.
                    </p>
                  </div>
                </div>
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    <h5 className="title">Sell Your DamageBDD NFT</h5>
                    <p>
                      Unlock new opportunities by selling your exclusive
                      DamageBDD NFTs. As a part of the DamageBDD ecosystem, your
                      NFTs can represent valuable test scenarios, smart
                      contracts, and other digital assets. Engage in the
                      decentralized marketplace, connect with stakeholders, and
                      earn rewards from your contributions to the collaborative
                      BDD platform.
                    </p>
                  </div>
                </div>
